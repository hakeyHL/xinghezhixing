...
function RGBColor(m) {
	...
	var d = [{
		...
		re : /^(\w{1})(\w{1})(\w{1})$/,
		example : ["#fb0", "f0f"],
		process : function(b) {return [parseInt(b[1] + b[1], 16), parseInt(b[2] + b[2], 16), parseInt(b[3] + b[3], 16)]}
	}];
...
(function() {
	function m() {
					...
					switch (b.nextCommand(), b.command.toUpperCase()) {
						...
						case "A":
							for (; !b.isCommandOrEnd();) {
								...
								}, s = function(b, a) {return (b[0] * a[1] < b[1] * a[0] ? -1 : 1) * Math.acos(m(b, a))}, o = s([1, 0],
		...
		a.Mouse = new function() {
			...
			this.onclick =
					function(a, d) {this.events.push({type : "onclick", x : a, y : d, run : function(a) {if (a.onclick)a.onclick()}})};
