 ...
 */
(function(g) {
	var i = g.seriesTypes, m = g.merge, s = g.extend, t = g.extendClass, u = g.getOptions().plotOptions, v = function() {}, j = g.each, x = HighchartsAdapter.grep, n = g.pick, q = g.Series, r = g.Color;
	u.treemap = m(u.scatter, {
		...
		dataLabels : {
			...
			formatter : function() {return this.point.name || this.point.id},
			inside : !0
		},
	...
	i.treemap = t(i.scatter, m({
		...
		getTree : function() {
			var a, b = [], c = [], d = function(a) {j(b[a], function(a) {b[""].push(a)})};
			this.nodeMap = [];
			...
			a = this.buildNode("",
					-1, 0, b, null);
			this.eachParents(this.nodeMap[this.rootNode], function(a) {a.visible = !0});
			this.eachChildren(this.nodeMap[this.rootNode], function(a) {a.visible = !0});
		...
		setTreeValues : function(a) {
			...
			j(a.children, function(a) {
				a =
						b.setTreeValues(a);
				b.insertElementSorted(d, a, function(a, b) {return a.val > b.val});
				a.ignore ? b.eachChildren(a, function(a) {s(a, {ignore : !0, isLeaf : !1, visible : !1})}) : c += a.val
			});
			e = n(f && f.value, c);
			s(a, {
				children : d,
		...
		eachChildren : function(a, b) {
			...
			b(a);
			d.length && j(d, function(a) {c.eachChildren(a, b)})
		},
		...
		calculateChildrenAreas : function(a, b) {
			...
			a.level - this.nodeMap[this.rootNode].level, f = this.levelMap[e + 1], h = n(c[f && f.layoutAlgorithm] && f.layoutAlgorithm,
					d.layoutAlgorithm), g = d.alternateStartingDirection, p = [], k, d = x(a.children, function(a) {return !a.ignore});
		...
		getLevels : function() {
			...
			b && j(b, function(b) {b.level !== void 0 && (a[b.level] = b)});
			return a
		},
		setColorRecursive : function(a,
			...
			if (a) {
				...
				a.children.length && j(a.children, function(a) {c.setColorRecursive(a, b)})
			}
		},
		alg_func_group : function(a, b, c, d) {
			...
			this.elArr = [];
			this.lP =
			{total : 0, lH : 0, nH : 0, lW : 0, nW : 0, nR : 0, lR : 0, aspectRatio : function(a, b) {return Math.max(a / b, b / a)}};
			...
			j(c.elArr, function(a) {
				if (b || o < n) {
					c.direction === 0 ? (e = l.x, f = l.y, h = p, g = a / h) :
							(e = l.x, f = l.y, g = k, h = a / g), d.push({x : e, y : f, width : h, height : g}), c.direction === 0 ?
							l.y += g :
							l.x += h;
				}
				o += 1
		...
		alg_func_lowAspectRatio : function(a, b, c) {
			var d = [], e = this, f, h = {x : b.x, y : b.y, parent : b}, g = 0, i = c.length - 1, k = new this.alg_func_group(b.height,
		...
		stripes : function(a, b) {return this.alg_func_fill(!1, a, b)},
		translate : function() {
		...
		drawPoints : function() {
			...
			j(b, function(b) {
				...
				d =
				{stroke : c.borderColor, "stroke-width" : c.borderWidth, dashstyle : c.borderDashStyle, r : 0, fill : n(b.color, a.color)};
				if (f) {
		...
		showDrillUpButton : function(a) {
			...
			this.drillUpButton ? this.drillUpButton.attr({text : a}).align() :
					(e = (d = c.theme) && d.states, this.drillUpButton =
							this.chart.renderer.button(a, null, null, function() {b.drillUp()}, d, e && e.hover,
