...
(function() {
	...
	var y, B = document, K = window, W = Math, r = W.round, V = W.floor, ta = W.ceil, u = W.max, C = W.min, O = W.abs, X = W.cos, aa = W.sin, ma = W.PI, ha = ma *
			...
			Ca = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect, Ob = La &&
					parseInt(Ba.split("Firefox/")[1], 10) < 4, fa = !ca && !ya &&
					!!B.createElement("canvas").getContext, $a, ab, Lb = {}, yb = 0, fb, T, Oa, za, zb, E, na = function() {return y}, Y = [], bb = 0, Ka = "div", P = "none", Pb = /^[0-9]+$/, jb = ["plotTop",
	...
	A.numberFormat = function(a, b,
			c, d) {
		var e = T.lang, a = +a || 0, f = b === -1 ? C((a.toString().split(".")[1] || "").length, 20) : isNaN(b = O(b)) ? 2 : b, b = c ===
		void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(D(a =
	...
	var Ub = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Vb = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
			Wb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function(a) {
				var b = [], c, d;
				(function(a) {
					a && a.stops ? d = Ua(a.stops, function(a) {return oa(a[1])}) :
				...
				return {
					get : function(c) {
						var f;
						d ? (f = z(a), f.stops = [].concat(f.stops), o(d, function(a, b) {f.stops[b] = [f.stops[b][0], a.get(c)]})) :
								f = b && !isNaN(b[0]) ? c === "rgb" ? "rgb(" + b[0] + "," +
								b[1] + "," + b[2] + ")" : c === "a" ? b[3] : "rgba(" + b.join(",") + ")" : a;
						return f
					}, brighten : function(a) {
                  if (d) {
                   o(d, function(b) {b.brighten(a)});
                  } else if (ra(a) && a !== 0) {
                   var c;
                   for (c = 0; c < 3; c++) {
		...
		getBBox : function(a) {
			...
			if (!b) {
             if (f.namespaceURI === Ca || c.forExport) {
              try {
               k = this.fakeTS &&
                       function(a) {o(f.querySelectorAll(".highcharts-text-shadow"), function(b) {b.style.display = a})}, La &&
               j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(P), b =
                       f.getBBox ? x({}, f.getBBox()) : {width : f.offsetWidth, height : f.offsetHeight}, i ? j.textShadow = i :
               k && k("")
              } catch (m) {}
              if (!b || b.width < 0) {
               b = {width : 0, height : 0}
	...
	ua.prototype = {
		...
		buildText : function(a) {
         for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !==
                 -1, g = b.childNodes, h, i, j = J(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k &&
          ...
          return m ?
                  ...
                  c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12,
                          a).h
         }, t = function(a) {return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")}; s--;) {
          b.removeChild(g[s]);
         }
		...
		rect : function(a, b, c, d, e, f) {
         ...
         if (e) {
          a.r = e;
			...
			g.rSetter = function(a) {J(this.element, {rx : a, ry : a})};
			return g.attr(a)
		},
		...
		symbol : function(a, b, c, d, e, f) {
         ...
         if (h) {
          ...
          k = function(a, b) {
           a.element &&
           (a.attr({width : b[0], height : b[1]}), a.alignByTranslate || a.translate(r((d - b[0]) / 2), r((e - b[1]) / 2)))
          }, j = a.match(i)[1], a = Lb[j] || f && f.width && f.height && [f.width, f.height], g =
                  this.image(j).attr({x : b, y : c}), g.isImg = !0, a ? k(g, a) :
                  (g.attr({width : 0, height : 0}), $("img", {onload : function() {k(g, Lb[j] = [this.width, this.height])}, src : j}));
         }
			return g
		},
		symbols : {
	...
	x(Q.prototype, {
      ...
      if (this.added) {
       var a =
               ...
               0, g = this.textAlign || "left", h = {left : 0, center : 0.5, right : 1}[g], i = this.shadows, j = this.styles;
           ...
           if (this.parentGroup = a) {
            if (b = a.div, !b) {
             ...
             o(j.reverse(), function(a) {
              ...
              e && (e = {className : e});
              b = a.div = a.div ||
                      $(Ka, e, {position : "absolute", left : (a.translateX || 0) + "px", top : (a.translateY || 0) + "px"},
                              b || c);
              d = b.style;
              x(a, {
	...
	if (!ca && !fa) {
		F = {
			...
			clip : function(a) {
				var b = this, c;
				a ? (c = a.members, ja(c, b), c.push(b), b.destroyClip = function() {ja(c, b)}, a = a.getCSS(b)) :
	...
	var Mb;
 if (fa) {
  A.CanVGRenderer = F = function() {Ca = "http://www.w3.org/1999/xhtml"}, F.prototype.symbols = {}, Mb = function() {
   function a() {
    var a = b.length, d;
    for (d = 0; d < a; d++) {
     b[d]();
   ...
   return {
	...
	Ta.prototype = {
		...
		getLabelPosition : function(a, b, c, d, e, f, g, h) {
			var i = this.axis, j = i.transA, k = i.reversed, l = i.staggerLines, m = i.tickRotCorr || {x : 0, y : 0}, c = p(e.y,
		...
		render : function(a,
         ...
         if (i && !isNaN(x)) {
          ...
          g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r), ga && a % ga && (q = !1), q &&
          !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
         }
		},
		...
		render : function() {
         ...
         if (m) {
          if (n) {
           ...
           if (m.hide(), m.onGetPath = function() {m.show()}, f) {
            a.label = f = f.destroy()
           }
          }
         } else if (n && n.length && (a.svgElem =
                         m = w.path(n).attr(t).add(), o)) {
          for (v in d = function(b) {m.on(b, function(c) {o[b].apply(a, [c])})}, o) {
           d(v);
          }
         }
	...
	Nb.prototype = {
		...
		refresh : function(a, b) {
			...
			j === !1 ? this.hide() : (this.isHidden && (db(d), d.attr("opacity", 1).show()), d.attr({text : j}), l =
					...
					this.updatePosition({plotX : f, plotY : g, negative : a.negative, ttBelow : a.ttBelow, h : h[2] || 0}), this.isHidden =
					!1);
	...
	Va.prototype = {
		...
		setDOMEvents : function() {
         ...
         if (ab) {
          b.ontouchstart = function(b) {a.onContainerTouchStart(b)}, b.ontouchmove =
                  function(b) {a.onContainerTouchMove(b)}, bb === 1 &&
	...
	x(A.Pointer.prototype, {
		...
		pinch : function(a) {
         ...
         if (a.type === "touchstart") {
          o(e, function(a, b) {d[b] = {chartX : a.chartX, chartY : a.chartY}}), g.x =
	...
	nb.prototype = {
		...
		destroyItem : function(a) {
			...
			o(["legendItem", "legendLine",
				"legendSymbol", "legendGroup"], function(b) {a[b] && (a[b] = a[b].destroy())});
			b && Ra(a.checkbox)
		},
		destroy : function() {
			...
			if (a > f) {
             ...
             if (!m) {
              this.nav = m = d.g().attr({zIndex : 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click",
                      function() {b.scroll(-1, k)}).add(m), this.pager = d.text("", 15, 10).css(j.style).add(m), this.down =
	...
	F.prototype = {
		...
		redraw : function(a) {
         ...
         if (i && !this.isResizing) {
          this.maxTicks = null, o(b, function(a) {a.setScale()});
         }
			this.getMargins();
		...
		getSelectedPoints : function() {
			var a = [];
			o(this.series, function(b) {a = a.concat(lb(b.points || [], function(a) {return a.selected}))});
			return a
		},
		...
		getContainer : function() {
         ...
         if (Da(a)) {
          this.renderTo = a = B.getElementById(a);
			...
			c = this.chartWidth;
			d = this.chartHeight;
			this.container = a = $(Ka, {className : "highcharts-container" + (b.className ? " " + b.className : ""), id : e}, x({
				position : "relative",
				overflow : "hidden",
				width : c + "px",
				height : d + "px",
		...
		drawChartBox : function() {
         ...
         if (m) {
          g ? g.animate(g.crisp({x : p, y : o, width : q, height : u, strokeWidth : -m})) : this.plotBorder =
                  b.rect(p, o, q, u, 0, -m).attr({stroke : a.plotBorderColor, "stroke-width" : m, fill : P, zIndex : 1}).add();
         }
			this.isDirtyBox = !1
		},
		...
		isReadyToRender : function() {
			...
			return !ca && K == K.top && B.readyState !== "complete" || fa && !K.canvg ?
					(fa ? Mb.push(function() {a.firstRender()}, a.options.global.canvasToolsURL) :
	...
	R.prototype = {
		...
		setData : function(a, b, c, d) {
			var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l &&
					!!l.categories, n = i.turboThreshold, v = this.xData, s = this.yData, q = (h = e.pointArrayMap) && h.length, a = a ||
					[];
			h = a.length;
			b = p(b, !0);
		...
		buildKDTree : function() {
			function a(b, d, g) {
				...
				g], b.sort(function(a, b) {return a[h] - b[h]}), i = Math.floor(i / 2), {
					point : b[i],
			...
			function b() {
				var b = lb(c.points, function(a) {return a.y !== null});
				c.kdTree = a(b, d, d)
			}
	...
	x(F.prototype, {
		addSeries : function(a, b, c) {
			...
			if (!d)b.loadingDiv = d = $(Ka, {className : "highcharts-loading"},
					x(e.style, {zIndex : 10, display : P}), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), H(b, "redraw",
					f);
	...
	U = {
		...
		animate : function(a) {
			...
			if (!a)o(c, function(a) {
				...
				c && (c.attr({r : a.startR || b.center[3] / 2, start : d, end : d}), c.animate({r : g.r, start : g.start, end : g.end},
						b.options.animation))
			}), b.animate = null
		},
		setData : function(a, b, c, d) {
	...
	R.prototype.alignDataLabel = function(a, b, c, d, e) {
		...
		if (l)d = x({x : g ? f.plotWidth - i : h, y : r(g ? f.plotHeight - h : i), width : 0, height : 0}, d), x(c,
				{width : j.width, height : j.height}), c.rotation ? (a = f.renderer.rotCorr(k, c.rotation), b[e ? "attr" : "animate"]({
	...
	if (M.pie)M.pie.prototype.drawDataLabels = function() {
		var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth,
				...
				2, s = n[1], x = m > 0, y, t, w, z = [[], []], B, A, D, F, G, E = [0, 0, 0, 0], L = function(a, b) {return b.y - a.y};
		...
		f < b[2] ? (b[2] = f, b[3] = /%$/.test(c.innerSize || 0) ? f * parseFloat(c.innerSize || 0) / 100 :
				...
				function(a) {if (a.dataLabel)a.dataLabel._pos = null}), this.drawDataLabels && this.drawDataLabels()) : g = !0;
		return g
	};
	if (M.column)M.column.prototype.alignDataLabel = function(a, b, c, d, e) {
		...
		if (h && (d = z(h), f &&
				(d = {x : g.yAxis.len - d.y - d.height, y : g.xAxis.len - d.x - d.width, width : d.height, height : d.width}), !j))f ?
	...
	(function(a) {
		...
		b.prototype.hideOverlappingLabels = function(a) {
			...
			for (d = 0; d < b; d++) {
				e = a[d];
				for (c = d + 1; c < b; ++c)if (k = a[c], e && k && e.placed && k.placed && e.newOpacity !== 0 && k.newOpacity !== 0 &&
						!(k.alignAttr.x > e.alignAttr.x + e.width || k.alignAttr.x + k.width < e.alignAttr.x ||
	...
	U = A.TrackerMixin = {
		drawTrackerPoint : function() {
			...
			var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath :
					...
					{cursor : k}, k = a.singlePoints, m, n = function() {if (f.hoverSeries !== a)a.onMouseOver()}, p = "rgba(192,192,192," +
					(ca ? 1.0E-4 : 0.002) + ")";
	...
	x(nb.prototype, {
		...
		createCheckboxForItem : function(a) {
			a.checkbox = $("input", {type : "checkbox", checked : a.selected, defaultChecked : a.selected}, this.options.itemCheckboxStyle,
					this.chart.container);
			H(a.checkbox, "click",
					function(b) {I(a.series || a, "checkboxClick", {checked : b.target.checked, item : a}, function() {a.select()})})
		}
	});
	...
	x(F.prototype, {
		showResetZoom : function() {
			...
			this.resetZoomButton =
					a.renderer.button(b.resetZoom, null, null, function() {a.zoomOut()}, d, e && e.hover).attr({
	...
	x(Ga.prototype, {
		select : function(a, b) {
			...
			var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = ba[e.type].marker && e.options.marker, h = g &&
					!g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker ||
	...
	x(R.prototype, {
		...
		setState : function(a) {
			...
			o(["group", "dataLabelsGroup",
				"markerGroup", "tracker"], function(a) {if (c[a])c[a][f]()});
