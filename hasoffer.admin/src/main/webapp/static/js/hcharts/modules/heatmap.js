 ...
 */
(function(h) {
	var n = h.Axis, r = h.Chart, k = h.Color, x = h.Legend, t = h.LegendSymbolMixin, u = h.Series, v = h.getOptions(), i = h.each, s = h.extend, y = h.extendClass, l = h.merge, m = h.pick, p = h.seriesTypes, w = h.wrap, o = function() {}, q = h.ColorAxis =
			function() {
				this.isColorAxis = !0;
	...
	s(q.prototype, {
		...
		drawLegendSymbol : function(a, b) {
			...
			if (a.dataClasses) {
				i(c.allItems, function(a) {a.isDataClass && a.legendGroup.destroy()}), d.isDirtyLegend = !0;
			}
	...
	i(["fill", "stroke"], function(a) {
		HighchartsAdapter.addAnimSetter(a, function(b) {b.elem.attr(a, q.prototype.tweenColors(k(b.start), k(b.end), b.pos))})
	});
	...
	p.heatmap = y(p.scatter, l(r, {
		...
		translate : function() {
			...
			this.chart.hasRendered && i(this.points, function(a) {a.shapeArgs.fill = a.options.color || a.color})
		},
